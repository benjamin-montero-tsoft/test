...
<div id="bodyFragmentChild">
	<form:form id="formEditarRegistroTipoDoc" commandName="editarTipoDocBean" action="${pageContext.request.contextPath}/actualizarRegistroTipoDoc.do">
		<table class="title">
			<tr><td class="	title">
				<spring:message code="editarRegistroTipoDoc.title"/>
			</td></tr>
		</table>
		<br>		
		<table>
			<tr>
				<td>
					<spring:message code="editarRegistroTipoDoc.tipoDocDW"/>
				</td>
				<td>
			...
			<tr>
				<td>
					<spring:message code="editarRegistroTipoDoc.tipoDocAmdoc"/>
				</td>
				<td>
			...
			<tr>
				<td>
					<spring:message code="editarRegistroTipoDoc.cargaGenero"/>
				</td>
				<td>
			...
			<tr>
				<td colspan="2">
					<br>
					<input id="validarFormulario" type="button" value="<spring:message code="button.guardarCambios"/>"/>
					<input id="buttonActualizar" type="submit" style="display: none;"/>
					<input id="buttonCancelar" type="submit" value="<spring:message code="button.cancelar"/>" onclick="$('#formEditarRegistroTipoDoc')[0].action='${pageContext.request.contextPath}/tiposDocumento.do'"/>				
				</td>
			</tr>			
		</table>
...
<script type="text/javascript">
	dojo.addOnLoad(function(){
		Spring.addDecoration(new Spring.AjaxEventDecoration({
			...
			formId: "formEditarRegistroTipoDoc",		
			event: "onclick", 
