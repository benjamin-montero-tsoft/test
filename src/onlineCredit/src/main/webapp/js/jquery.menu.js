        ...
        return this.each(function(){
            ...
            menu.find('ul li > a').bind('click',function(event){
                ...
                if (currentlink.parent().find('ul.active').size()==1)
                {
                    ...
                    currentlink.parent().find('ul.active').slideUp('fast',function(){
                ...
                else
                {
                    ...
                    menu.find('ul li ul.active').slideUp('fast',function(){
            ...
            //		$("li:has(ul) > a", this).hover(mouseOver, mouseOut);
                    // una vez que cerramos el que estaba abierto le quitamos la clase active
                  //menu.find('ul li ul').removeClass('active');
            // 	});
            //});
